 ...
 * Date: 25.6.2015
 *      // TODO: 21.3.2017 use more data
 */
public class StatsRowPanel extends JPanel implements Comparator<StatsRowPanel> {
            ...
            public void mouseClicked(MouseEvent e) {
                if (e.getButton() == MouseEvent.BUTTON1){
                    if (e.getClickCount() == 1 && roleDevelPanel != null){
                        ...
                        frame.setLocationRelativeTo(StatsRowPanel.this);
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(layout.createParallelGroup()
                ...
                .addComponent(labelIcon, GroupLayout.PREFERRED_SIZE, height, GroupLayout.PREFERRED_SIZE)
    ...
    // champ
    public void update(String champion, int gamesTotal, List<Season.Game> gameRecords){
        ...
        updateContent(gameRecords, gameRecords.get(0).getUser().getRole().equals(Role.support.toString()));
        roleDevelPanel.update(champion, gameRecords);
    }
    // role
    public void update(Role role, int gamesTotal, List<Season.Game> gameRecords){
    ...
    private void updateContent(List<Season.Game> gameRecords, boolean isSupport){
        int winsG = 0;
        int defsG = 0;
        int kills = 0;
        int deaths = 0;
    ...
    @Override
    public int compare(StatsRowPanel o1, StatsRowPanel o2) {
